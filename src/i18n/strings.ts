...
export const strings: Strings = {
    ja: {
        ...
        // settings modal — user section
        'user.title': '自分の設定',
        'user.basisTitle': '計算基準の選択',
        'user.lifeYears': '寿命 {n}年',
        'user.healthyLife': '健康寿命',
        'user.retirementAge': '定年退職年齢',
        'basis.life': '残りの人生',
        'basis.healthy': '健康でいられる時間',
        'basis.working': '社会で活躍できる時間',

        // settings modal — people section
        'people.title': '大切な人との時間',
        'people.addNew': '新しい対象を追加',
        'people.edit': '編集',
        'people.ageInputMethod': '年齢の入力方法',
        'people.colorLabel': '色',
        'people.empty': 'まだ対象が登録されていません',
        'people.meetingsCount': '会える回数',
        'people.sharedHours': '共有できる時間',
        'people.timesPerYearShort': '{n}回/年',
        'people.ageUnknown': '年齢不明',
        'people.deleteConfirmTarget': 'この対象を削除しますか？',
        'people.addFromForm': '上記のフォームから追加してください',
    ...
    en: {
        ...
        'user.title': 'Your Settings',
        'user.basisTitle': 'Calculation basis',
        'user.lifeYears': 'Life {n} years',
        'user.healthyLife': 'Healthy life expectancy',
        'user.retirementAge': 'Retirement age',
        'basis.life': 'Remaining life',
        'basis.healthy': 'Healthy years',
        'basis.working': 'Working years',

        'people.title': 'Time with your people',
        'people.addNew': 'Add a person',
        'people.edit': 'Edit',
        'people.ageInputMethod': 'How to enter age',
        'people.colorLabel': 'Color',
        'people.empty': 'No one in your universe yet',
        'people.meetingsCount': 'Meetings left',
        'people.sharedHours': 'Shared hours',
        'people.timesPerYearShort': '{n}x/yr',
        'people.ageUnknown': 'Age unknown',
        'people.deleteConfirmTarget': 'Delete this person?',
        'people.addFromForm': 'Add someone using the form above',
